#!/usr/bin/env python3
"""course.py — track where you are in the drone course and what to study next.
...
def cmd_hw(p: dict, g: dict, args) -> None:
    ...
    if not args.action or args.action == "list":
        ...
        print("Details, prices and US suppliers: HARDWARE.md")
        return
...
def main(argv: list[str] | None = None) -> None:
    ap = argparse.ArgumentParser(description="Drone course progress tool", formatter_class=argparse.RawDescriptionHelpFormatter,
                                 epilog=__doc__)
